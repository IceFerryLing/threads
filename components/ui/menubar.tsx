...
// 这个文件是一个菜单栏组件，使用了 Radix UI 的 Menubar 组件库来构建可访问性良好的菜单栏。它定义了多个子组件，如 MenubarItem、MenubarTrigger、MenubarContent 等，并为它们添加了样式和功能。通过这些组件，开发者可以轻松创建具有子菜单、复选项和单选项的复杂菜单栏界面。
